...
async function getSushiswapPoolData(holderInfo, poolAddress, farmNumber, web3) {
    ...
    return newPoolData(poolAddress, holderInfo, totalLp, holderLp, lpTokenDecimals, positionValues, farmNumber !== '' ? MasterChefAddress : '', indirectFranctionOfPool, poolDataRes[7]);     
}
...
async function getOneInchPoolData(holderInfo, poolAddress, farmAddress, web3) {
    ...
    return newPoolData(poolAddress, holderInfo, totalLp, holderLp, lpTokenDecimals, positionValues, farmAddress, indirectFranctionOfPool, poolDataRes[7]);    
}
